    ...
    private static void menu ( ) {
       ...
       try{ System.out.println("Hola presiona uno de los siguientes numeros para conocer el area y perimetro de una de las siguientes figuras."+"\n "
        ...
        if(r1==1){
            ...
            System.out.println("Presiona 1 para calcular el area o 2 para calcular el perimetro.");
            int  r3 = entrada.nextInt();
            if(r3==1){ System.out.println("Dime el radio del circulo");
                v1 = entrada.nextDouble();
                Circle circle = new Circle(v1);
                System.out.println("area circulo " + circle.getarea());} else if (r3 ==2){
            ...
            System.out.println("Presiona 1 para calcular el area o 2 para calcular el perimetro.");
            int  r3 = entrada.nextInt();
            if(r3==1){System.out.println("Dime el lado  del triangulo");
                v1 = entrada.nextDouble();
                Triangle triangle = new Triangle(v1);
                System.out.println("area triangulo " + triangle.getarea());

            } else if (r3 ==2){System.out.println("Dime el lado  del triangulo");
                v1 = entrada.nextDouble();
                Triangle triangle = new Triangle(v1);
